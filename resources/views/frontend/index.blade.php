                    ...
                    <div class="container">
                        <div class="row slider-text justify-content-center align-items-center"
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <h2 class="subheading mb-4">Chúng tôi cung cấp các loại rau, củ &amp; hoa quả hữu
                                    cơ</h2>
                            </div>
            ...
            <div class="row">
                @foreach($newProducts as $product)
                    <div class="col-md-6 col-lg-3">
                        <div class="product">
                            <a href="{{ route('shop.productDetail',['slug' => $product->slug]) }}" class="img-prod"><img
                                    class="img-fluid" src="{{ asset($product->image)}}" alt="Colorlib Template">
                                <div class="overlay"></div>
                            </a>
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price"><span class="mr-2 price-dc">{{ number_format($product -> price,0,",",".") }} đ</span><span>{{ number_format($product -> sale,0,",",".") }} đ</span>
                                        </p>
                                    </div>
                                </div>
